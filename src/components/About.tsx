...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left side - Content */}
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              About <span className="text-orange-400">CORE</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="text-slate-400">Students Impacted</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {values.map((value, index) => (
              <div key={index} className="flex items-start gap-4 p-6 bg-white/5 backdrop-blur-sm rounded-xl hover:bg-white/10 transition-all duration-300">
                <div className="flex items-center justify-center w-12 h-12 bg-blue-600/20 backdrop-blur-sm rounded-lg">
